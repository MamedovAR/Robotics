...
def generate_launch_description():
    ...
    # Setup project paths
    pkg_project_bringup = get_package_share_directory('robot_bringup_sensors')
    pkg_project_description = get_package_share_directory('robot_description_sensor')
    ...
    run_program = Node(
        package="robot_and_camera",
        executable="robot_and_camera"
    )
